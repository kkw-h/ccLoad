...
func (h *HybridStore) UpdateTokenStats(ctx context.Context, tokenHash string, outcome model.TokenStatOutcome, duration float64, isStreaming bool, firstByteTime float64, promptTokens int64, completionTokens int64, cacheReadTokens int64, cacheCreationTokens int64, costUSD float64, effectiveCostUSD float64) error {
	if err := h.mysql.UpdateTokenStats(ctx, tokenHash, outcome, duration, isStreaming, firstByteTime, promptTokens, completionTokens, cacheReadTokens, cacheCreationTokens, costUSD, effectiveCostUSD); err != nil {
		return err
	}

	h.syncToSQLite("UpdateTokenStats", func() error {
		return h.sqlite.UpdateTokenStats(ctx, tokenHash, outcome, duration, isStreaming, firstByteTime, promptTokens, completionTokens, cacheReadTokens, cacheCreationTokens, costUSD, effectiveCostUSD)
	})
