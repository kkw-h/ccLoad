...
func claudeBypassSignatureValidationOptions() signature.ClaudeSignatureValidationOptions {
	return signature.ClaudeSignatureValidationOptions{Strict: true}
}

func antigravityModelGroup(modelName string) string {
	return string(signature.SignatureProviderFromModelName(modelName))
}
