...
func antigravityAltContext() context.Context {
	// The converter's public context contract uses this legacy string key.
	//nolint:staticcheck // keep the test aligned with that contract
	return context.WithValue(context.Background(), "alt", "")
}
